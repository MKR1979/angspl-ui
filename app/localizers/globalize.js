...
let timeRangeFormat = ({ start, end }, culture, local) =>
  local.format(start, { time: 'short' }, culture) + ' – ' + local.format(end, { time: 'short' }, culture);

let timeRangeStartFormat = ({ start }, culture, local) => local.format(start, { time: 'short' }, culture) + ' – ';

let timeRangeEndFormat = ({ end }, culture, local) => ' – ' + local.format(end, { time: 'short' }, culture);

let weekRangeFormat = ({ start, end }, culture, local) =>
  local.format(start, 'MMM dd', culture) + ' – ' + local.format(end, dates.eq(start, end, 'month') ? 'dd' : 'MMM dd', culture);
