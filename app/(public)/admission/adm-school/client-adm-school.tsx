...
import useAdmissionCart from './useAdmSchool';
...
import SuccessMessageAdm from './SuccessMessageAdm';
...
import './successMessageAdmission.css';
...
const ClientAdmSchool = () => {
  ...
  const primaryEmail = state.dtoAdmissionSchool.email || state.dtoAdmissionSchool.father_email || state.dtoAdmissionSchool.mother_email || '';
  ...
  return (
    <>
      {submitted ? (
        <SuccessMessageAdm
          name={`${state.dtoAdmissionSchool.first_name} ${state.dtoAdmissionSchool.last_name}`}
          user_id={studentId ?? 0}
          course_id={state.dtoAdmissionSchool.course_id}
          course={state.dtoAdmissionSchool.course_name}
              ...
              <MyGrid container spacing={2} style={{ border: '3px solid rgb(238, 242, 246)', padding: '0.1rem 1rem' }}>
                ...
                <MyGrid size={{ xs: 12 }}>
                  ...
                  <ul style={{ paddingLeft: '1.5rem', listStyleType: 'disc' }}>
                    <li>
                      I fully understand that the school, on accepting the registration of my ward, is not in any way bound to grant
                      admission. I also understand that the decision of the school authorities regarding admission will be final and binding
                      on me.
                    </li>
                    <li>I fully understand that xxxxx xxxxx School, Bhopal has the right to offer admission based on vacancy of seats.</li>
                    <li>
                      I hereby certify that the Date of Birth and spelling of name of my ward given in this form are true and correct and I
                      shall not make any request for change.
                    </li>
                    <li>
                      I undertake that the information / documents submitted in this form are true and correct and not misleading and no
                      relevant information has been concealed. I understand that false or misleading information or withholding correct
                      information may disqualify my ward for admission/education at this school.
                    </li>
                  </ul>
                  ...
                  <ul style={{ paddingLeft: '1.5rem', listStyleType: 'disc' }}>
                    <li>
                      Registration once completed for a particular year is <strong>non-transferable</strong> to any other year or to any
                      other child.
                    </li>
...
export default memo(ClientAdmSchool, (prevProps, nextProps) => {
