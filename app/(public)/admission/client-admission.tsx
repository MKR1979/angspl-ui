...
const ClientAdmission = () => {
  const {
    state,is10threq,is12threq,isgradreq,
    onEMailIdBlur,
    onLastNameBlur,
    onFirstNameBlur,
    onDobBlur,
                      ...
                      <MyGrid size={{ xs: 12, sm: 6  }}>
                        ...
                        <MyGrid size={{ xs: 12, sm: 6 }}>
                          ...
                          <MyTextField
                              ...
                              value={
                                isNaN(state.dtoAdmission.highersschoolpercentage)
                                  ? ''
                                  : String(state.dtoAdmission.highersschoolpercentage)
                              }
                              onChange={onInputChange}
                              inputProps={{
                                maxLength: 2,
...
export default memo(ClientAdmission);
