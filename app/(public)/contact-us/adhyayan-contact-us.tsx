            ...
            <StyledPaper sx={{ height: '100%' }}>
              ...
              <Box sx={{ mt: 4 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', marginTop: '10px' }}>
                  <FaYoutube size={38} style={{ marginRight: '1.1rem', color: '#FF0000' }} />
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', marginTop: '10px', gap: '8px' }}>
                  <FaWhatsapp size={28} color="green" className="whatsapp-icon" />
                  ...
                  <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
                    ...
                    >
                      <a href={`tel:${companyInfo.company_phone_no}`}>
...
export default memo(ClientAdhyayanContactUs, (prevProps, nextProps) => eq(prevProps, nextProps));
