            ...
            >
              ...
              >
                ...
                <MyTypography variant="h6" component="h4" align="center" gutterBottom sx={{ fontSize: '1rem', mb: 0 }}>
                  Choose the Right Plan for Your College
                </MyTypography>
                <MyButton
                  variant="outlined"
                  sx={{
                ...
                <MyGrid size={{ xs: 12, sm: 12, md: 3 }} style={{ display: 'flex' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MyButton variant="contained" fullWidth onClick={() => goToCompanyModule('College', 'Startup', 'Monthly', 3000)}>
                        Subscribe Now
                      </MyButton>
                    </MyCardContent>
                  </MyCard>
                ...
                <MyGrid size={{ xs: 12, sm: 12, md: 3 }} style={{ display: 'flex' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MyButton variant="contained" fullWidth onClick={() => goToCompanyModule('College', 'Premium', 'Monthly', 5000)}>
                        Subscribe Now
                      </MyButton>
                    </MyCardContent>
                  </MyCard>
                ...
                <MyGrid size={{ xs: 12, sm: 12, md: 3 }} style={{ display: 'flex' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MyButton variant="contained" fullWidth onClick={() => goToCompanyModule('College', 'Enterprise', 'Monthly', 9999)}>
                        Subscribe Now
                      </MyButton>
                    </MyCardContent>
                  </MyCard>
                ...
                <MyGrid size={{ xs: 12, sm: 12, md: 3 }} style={{ display: 'flex' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MyButton variant="contained" fullWidth onClick={() => goToCompanyModule('College', 'Startup', 'Yearly', 32000)}>
                        Subscribe Now
                      </MyButton>
                    </MyCardContent>
                  </MyCard>
                ...
                <MyGrid size={{ xs: 12, sm: 12, md: 3 }} style={{ display: 'flex' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MyButton variant="contained" fullWidth onClick={() => goToCompanyModule('College', 'Premium', 'Yearly', 59000)}>
                        Subscribe Now
                      </MyButton>
                    </MyCardContent>
                  </MyCard>
                ...
                <MyGrid size={{ xs: 12, sm: 12, md: 3 }} style={{ display: 'flex' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <MyButton variant="contained" fullWidth onClick={() => goToCompanyModule('College', 'Enterprise', 'Yearly', 95000)}>
                        Subscribe Now
                      </MyButton>
                    </MyCardContent>
                  </MyCard>
