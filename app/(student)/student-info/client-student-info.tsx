...
const ClientStudentInfo = () => {
  const { state, onImageError, onImageClick, UploadImage } = useStudentInfo();
        ...
        <MyGrid container spacing={3}>
          ...
          <MyGrid size={{ xs: 12, md: 8 }}>
            ...
            <MyGrid container spacing={2}>
              ...
              <InfoItem label="DOB" value={state.dtoAdmission.dob ? new Date(state.dtoAdmission.dob).toLocaleDateString() : 'N/A'} />
            </MyGrid>
            ...
            <MyGrid container spacing={2}>
              ...
              <InfoItem
                ...
                value={state.dtoAdmission.admission_date ? new Date(state.dtoAdmission.admission_date).toLocaleDateString() : 'N/A'}
              />
              ...
              <InfoItem label="Tenth Proof" value={typeof state.dtoAdmission.tenthproof} />
              <InfoItem label="Twelfth Proof" value={typeof state.dtoAdmission.twelthproof} />
            </MyGrid>
          </MyGrid>
