...
import useInvoiceEntry from './useInvoiceEntry';
...
import { arrDiscountType, arrLeadTime, arrInvoiceStatus, getLocalTime, numberFormat } from '@/app/common/Configuration';
...
const InvoiceEntry = (props: InvoiceEntryProps) => {
  const {
    apiRef,
    paginationModel,
    setPaginationModel,
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      valueFormatter: useCallback(
        (value: any) => (value ? state.dtoInvoice.currency_symbol + numberFormat(Number(value), 2) : ''),
        [state.dtoInvoice.currency_symbol]
      )
    },
    {
      ...
      headerAlign: 'right',
      valueFormatter: useCallback(
        (value: any) => (value ? state.dtoInvoice.currency_symbol + numberFormat(Number(value), 0) : ''),
        [state.dtoInvoice.currency_symbol]
      )
    },
    {
  ...
  return (
    <MyLocalizationProvider>
          ...
          <MyTabPanel value={state.tabIndex} index={0}>
            <MyGrid container spacing={2}>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField label="Invoice #" name="invoice_no" value={state.dtoInvoice.invoice_no} onChange={onInputChange} />
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyDatePicker
                  label="Invoice Date"
                  ...
                  value={
                    dayjs(getLocalTime(state.dtoInvoice.invoice_date)).format('MM/DD/YYYY') === '12/31/1899'
                      ? null
                      : dayjs(getLocalTime(state.dtoInvoice.invoice_date)).toDate()
                  }
                  onBlur={onInvoiceDateBlur}
                  error={state.errorMessages.invoice_date ? true : false}
                ></MyDatePicker>
                <MyTypography className="error"> {state.errorMessages.invoice_date}</MyTypography>
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  open={state.open1}
                  onOpen={setOpen1}
                  onClose={setClose1}
                  value={{ id: state.dtoInvoice.customer_id, text: state.dtoInvoice.customer_name }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen3}
                  onClose={setClose3}
                  value={{ id: state.dtoInvoice.contact_id, text: state.dtoInvoice.contact_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyDatePicker
                  ...
                  value={
                    dayjs(getLocalTime(state.dtoInvoice.due_date)).format('MM/DD/YYYY') === '12/31/1899'
                      ? null
                      : dayjs(getLocalTime(state.dtoInvoice.due_date)).toDate()
                  }
                ></MyDatePicker>
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.customer_ref_no}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen4}
                  onClose={setClose4}
                  value={{ id: state.dtoInvoice.incoterm_id, text: state.dtoInvoice.incoterm_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen5}
                  onClose={setClose5}
                  value={{ id: state.dtoInvoice.term_id, text: state.dtoInvoice.term_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onClose={setClose11}
                  value={{
                    id: state.dtoInvoice.currency_id,
                    text: state.dtoInvoice.currency_name
                  }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onClose={setClose16}
                  value={{
                    text: state.dtoInvoice.status
                  }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ text: '' }}
                  options={arrInvoiceStatus}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField multiline rows={5} label="Notes" name="notes" value={state.dtoInvoice.notes} onChange={onInputChange} />
              </MyGrid>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  label="Total Amount"
                  value={numberFormat(state.dtoInvoice.total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
                      inputProps: { prefix: state.dtoInvoice.currency_symbol }
                    }
                  }}
                />
              </MyGrid>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoInvoice.discount_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoInvoice.sub_total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  label="Tax Amount"
                  value={numberFormat(state.dtoInvoice.tax_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.shipping_charges}
                  onChange={onInputChange}
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyBox sx={{ display: 'flex' }}>
                  <MyAutocomplete
                    ...
                    onOpen={setOpen10}
                    onClose={setClose10}
                    value={{ id: state.dtoInvoice.shipping_tax_id, text: state.dtoInvoice.shipping_tax_description }}
                    getOptionLabel={(option: any) => option.text}
                    firstitem={{ id: 0, text: '' }}
                  ...
                  <MyTextField
                    ...
                    value={numberFormat(state.dtoInvoice.shipping_tax_amount, 2)}
                    disabled
                    slotProps={{
                      input: {
                        inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoInvoice.grand_total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid container spacing={2}>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.billing_address}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.billing_city_name}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen12}
                  onClose={setClose12}
                  value={{ id: state.dtoInvoice.billing_state_id, text: state.dtoInvoice.billing_state_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen13}
                  onClose={setClose13}
                  value={{ id: state.dtoInvoice.billing_country_id, text: state.dtoInvoice.billing_country_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.billing_zip_code}
                  onChange={onInputChange}
            ...
            <MyGrid container spacing={2}>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.shipping_address}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.shipping_city_name}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen14}
                  onClose={setClose14}
                  value={{ id: state.dtoInvoice.shipping_state_id, text: state.dtoInvoice.shipping_state_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen15}
                  onClose={setClose15}
                  value={{ id: state.dtoInvoice.shipping_country_id, text: state.dtoInvoice.shipping_country_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrCountryLookup}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoInvoice.shipping_zip_code}
                  onChange={onInputChange}
      ...
      <MyDialog
        ...
        fullWidth
      >
        <MyDialogTitle> {state.dtoInvoiceItem.item_no > 0 ? 'Edit' : 'Add'} Invoice Item</MyDialogTitle>
        <MyIconButton
          aria-label="close"
          ...
          <MyGrid container spacing={2}>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                ...
                onOpen={setOpen6}
                onClose={setClose6}
                value={{ id: state.dtoInvoiceItem.product_id, text: state.dtoInvoiceItem.product_name }}
                getOptionLabel={(option: any) => option.text}
                firstitem={{ id: 0, text: '' }}
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField label="Product Code" name="productcode" value={state.dtoInvoiceItem.part_number} disabled={true} />
            </MyGrid>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                open={state.open7}
                onOpen={setOpen7}
                onClose={setClose7}
                value={{ id: state.dtoInvoiceItem.unit_id, text: state.dtoInvoiceItem.unit_name }}
                getOptionLabel={(option: any) => option.text}
                firstitem={{ id: 0, text: '' }}
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Quantity"
                name="qty"
                value={state.dtoInvoiceItem.qty}
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Price"
                name="price"
                value={state.dtoInvoiceItem.price}
                onChange={onInputChange1}
                onBlur={onPriceBlur}
                slotProps={{
                  input: {
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyBox sx={{ display: 'flex' }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen8}
                  onClose={setClose8}
                  value={{ text: state.dtoInvoiceItem.discount_type }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ text: '' }}
                ...
                <MyTextField
                  label="Discount"
                  name="discount"
                  value={state.dtoInvoiceItem.discount}
                  onChange={onInputChange1}
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
                      inputProps: {
                        prefix: state.dtoInvoiceItem.discount_type === 'Fixed' ? state.dtoInvoice.currency_symbol : '',
                        suffix: state.dtoInvoiceItem.discount_type === 'Fixed' ? '' : '%'
                      }
                    }
                  }}
                  sx={{ mr: 1 }}
                ...
                <MyTextField
                  label="Discount Amount"
                  value={numberFormat(state.dtoInvoiceItem.discount_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyBox sx={{ display: 'flex' }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen9}
                  onClose={setClose9}
                  value={{ id: state.dtoInvoiceItem.tax_id, text: state.dtoInvoiceItem.tax_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrTaxLookup}
                ...
                <MyTextField
                  label="Tax Amount"
                  value={numberFormat(state.dtoInvoiceItem.tax_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Amount"
                name="amount"
                value={numberFormat(state.dtoInvoiceItem.amount, 2)}
                disabled={true}
                slotProps={{
                  input: {
                    inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                ...
                disableClearable
                options={arrLeadTime}
                value={state.dtoInvoiceItem.lead_time}
      ...
      {state.visibleDialog && (
        <MyConfirmDialog
          ...
          title="Confirm Invoice Item Removal"
          onNoClick={toggleDialog}
          onYesClick={DeleteSelected}
          onClose={toggleDialog}
        >
          <MyTypography variant="body1"> Are you sure you want to delete this Invoice item? This cannot be undone.</MyTypography>
        </MyConfirmDialog>
      )}
...
export default memo(InvoiceEntry, (prevProps, nextProps) => {
