...
import ClientAddDeliverySlip from './client-add-delivery-slip';
...
export const metadata: Metadata = {
  title: 'Add Delivery Slip'
};

export const revalidate = 0;

export default async function AddDeliverySlipPage() {
  ...
  const dtoDeliverySlip: DeliverySlipDTO = { ...DELIVERY_SLIP };
  try {
