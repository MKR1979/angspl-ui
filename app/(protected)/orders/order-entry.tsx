...
import { arrDiscountType, arrLeadTime, arrOrderStatus, getLocalTime, numberFormat } from '@/app/common/Configuration';
  ...
  return (
    <MyLocalizationProvider>
          ...
          <MyTabPanel value={state.tabIndex} index={0}>
            <MyGrid container spacing={2}>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField label="Order #" value={state.dtoOrder.order_no} disabled />
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyDatePicker
                  label="Order Date"
                  ...
                  value={
                    dayjs(getLocalTime(state.dtoOrder.order_date)).format('MM/DD/YYYY') === '12/31/1899'
                      ? null
                      : dayjs(getLocalTime(state.dtoOrder.order_date)).toDate()
                  }
                  onBlur={onOrderDateBlur}
                  error={state.errorMessages.order_date ? true : false}
                ></MyDatePicker>
                <MyTypography className="error"> {state.errorMessages.order_date}</MyTypography>
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  disabled={state.dtoOrder.id > 0}
                  open={state.open17}
                  onOpen={setOpen17}
                  onClose={setClose17}
                  value={{ id: state.dtoOrder.quote_id, text: state.dtoOrder.quote_no }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrQuoteLookup}
                  onChange={onQuoteNoChange}
                  onBlur={onQuoteNoBlur}
                  renderInput={(params) => (
                    <MyTextField
                      {...params}
                      label="Quote #"
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  disabled={state.dtoOrder.quote_id > 0}
                  open={state.open1}
                  onOpen={setOpen1}
                  onClose={setClose1}
                  value={{ id: state.dtoOrder.customer_id, text: state.dtoOrder.customer_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen2}
                  onClose={setClose2}
                  value={{ id: state.dtoOrder.sales_person_id, text: state.dtoOrder.sales_person_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen3}
                  onClose={setClose3}
                  value={{ id: state.dtoOrder.contact_id, text: state.dtoOrder.contact_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                ...
                <MyDatePicker
                  ...
                  value={
                    dayjs(getLocalTime(state.dtoOrder.due_date)).format('MM/DD/YYYY') === '12/31/1899'
                      ? null
                      : dayjs(getLocalTime(state.dtoOrder.due_date)).toDate()
                  }
                ></MyDatePicker>
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.customer_ref_no}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen4}
                  onClose={setClose4}
                  value={{ id: state.dtoOrder.incoterm_id, text: state.dtoOrder.incoterm_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen5}
                  onClose={setClose5}
                  value={{ id: state.dtoOrder.term_id, text: state.dtoOrder.term_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onClose={setClose11}
                  value={{
                    id: state.dtoOrder.currency_id,
                    text: state.dtoOrder.currency_name
                  }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField multiline rows={5} label="Notes" name="notes" value={state.dtoOrder.notes} onChange={onInputChange} />
              </MyGrid>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  label="Total Amount"
                  value={numberFormat(state.dtoOrder.total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
                      inputProps: { prefix: state.dtoOrder.currency_symbol }
                    }
                  }}
                />
              </MyGrid>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoOrder.discount_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoOrder.sub_total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  label="Tax Amount"
                  value={numberFormat(state.dtoOrder.tax_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.shipping_charges}
                  onChange={onInputChange}
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyBox sx={{ display: 'flex' }}>
                  <MyAutocomplete
                    ...
                    onOpen={setOpen10}
                    onClose={setClose10}
                    value={{ id: state.dtoOrder.shipping_tax_id, text: state.dtoOrder.shipping_tax_description }}
                    getOptionLabel={(option: any) => option.text}
                    firstitem={{ id: 0, text: '' }}
                  ...
                  <MyTextField
                    ...
                    value={numberFormat(state.dtoOrder.shipping_tax_amount, 2)}
                    disabled
                    slotProps={{
                      input: {
                        inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoOrder.grand_total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid container spacing={2}>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.billing_address}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.billing_city_name}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen12}
                  onClose={setClose12}
                  value={{ id: state.dtoOrder.billing_state_id, text: state.dtoOrder.billing_state_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen13}
                  onClose={setClose13}
                  value={{ id: state.dtoOrder.billing_country_id, text: state.dtoOrder.billing_country_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.billing_zip_code}
                  onChange={onInputChange}
            ...
            <MyGrid container spacing={2}>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.shipping_address}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.shipping_city_name}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen14}
                  onClose={setClose14}
                  value={{ id: state.dtoOrder.shipping_state_id, text: state.dtoOrder.shipping_state_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen15}
                  onClose={setClose15}
                  value={{ id: state.dtoOrder.shipping_country_id, text: state.dtoOrder.shipping_country_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrCountryLookup}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoOrder.shipping_zip_code}
                  onChange={onInputChange}
      ...
      <MyDialog
        ...
        fullWidth
      >
        <MyDialogTitle> {state.dtoOrderItem.item_no > 0 ? 'Edit' : 'Add'} Order Item</MyDialogTitle>
        <MyIconButton
          aria-label="close"
          ...
          <MyGrid container spacing={2}>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                ...
                onOpen={setOpen6}
                onClose={setClose6}
                value={{ id: state.dtoOrderItem.product_id, text: state.dtoOrderItem.product_name }}
                getOptionLabel={(option: any) => option.text}
                firstitem={{ id: 0, text: '' }}
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField label="Product Code" value={state.dtoOrderItem.part_number} disabled={true} />
            </MyGrid>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField label="Unit" value={state.dtoOrderItem.unit_name} disabled={true} />
            </MyGrid>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Quantity"
                name="qty"
                value={state.dtoOrderItem.qty}
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Price"
                name="price"
                value={state.dtoOrderItem.price}
                onChange={onInputChange1}
                onBlur={onPriceBlur}
                slotProps={{
                  input: {
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyBox sx={{ display: 'flex' }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen8}
                  onClose={setClose8}
                  value={{ text: state.dtoOrderItem.discount_type }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ text: '' }}
                ...
                <MyTextField
                  label="Discount"
                  name="discount"
                  value={state.dtoOrderItem.discount}
                  onChange={onInputChange1}
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
                      inputProps: {
                        prefix: state.dtoOrderItem.discount_type === 'Fixed' ? state.dtoOrder.currency_symbol : '',
                        suffix: state.dtoOrderItem.discount_type === 'Fixed' ? '' : '%'
                      }
                    }
                  }}
                  sx={{ mr: 1 }}
                ...
                <MyTextField
                  label="Discount Amount"
                  value={numberFormat(state.dtoOrderItem.discount_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyBox sx={{ display: 'flex' }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen9}
                  onClose={setClose9}
                  value={{ id: state.dtoOrderItem.tax_id, text: state.dtoOrderItem.tax_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrTaxLookup}
                ...
                <MyTextField
                  label="Tax Amount"
                  value={numberFormat(state.dtoOrderItem.tax_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Amount"
                name="amount"
                value={numberFormat(state.dtoOrderItem.amount, 2)}
                disabled={true}
                slotProps={{
                  input: {
                    inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                ...
                disableClearable
                options={arrLeadTime}
                value={state.dtoOrderItem.lead_time}
      ...
      {state.visibleDialog && (
        <MyConfirmDialog
          ...
          title="Confirm Order Item Removal"
          onNoClick={toggleDialog}
          onYesClick={DeleteSelected}
          onClose={toggleDialog}
        >
          <MyTypography variant="body1"> Are you sure you want to delete this Order item? This cannot be undone.</MyTypography>
        </MyConfirmDialog>
      )}
...
export default memo(OrderEntry, (prevProps, nextProps) => {
