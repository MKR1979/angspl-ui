...
const ClientEventList = ({ arrEventCalendarDTO }: Props) => {
  const {
    ...
    onStatusChange,
    onBudgetBlur
  } = useEventList({ arrEventCalendarDTO });
      ...
      <MyCard>
        <MyCardContent>
          <Calendar
            ...
            localizer={localizer}
            components={{
              eventWrapper: ({ event, children }: any) => <div onContextMenu={(e) => handleContextMenu(e, event)}>{children}</div>
            }}
            ...
            <MyGrid container spacing={2}>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  error={!!state.errorMessages.event_name}
                />
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  error={!!state.errorMessages.budget}
                />
...
export default memo(ClientEventList, (prevProps, nextProps) => eq(prevProps, nextProps));
