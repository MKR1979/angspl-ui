        ...
        <MyCardContent>
          <MyGrid container spacing={2}>
            ...
            <MyGrid size={{ xs: 12, md: 6 }}>
              ...
              <MyTypography>{state.dtoEvent.start_date_time
                ? dayjs(state.dtoEvent.start_date_time).format('DD-MM-YYYY hh:mm A')
                : 'N/A'}</MyTypography>
            </MyGrid>
            <MyGrid size={{ xs: 12, md: 6 }}>
              <MyTypography variant="subtitle2">End Date:</MyTypography>
              <MyTypography>{state.dtoEvent.end_date_time
                ? dayjs(state.dtoEvent.end_date_time).format('DD-MM-YYYY hh:mm A')
                : 'N/A'}</MyTypography>
            </MyGrid>
            <MyGrid size={{ xs: 12, md: 6 }}>
            ...
            <MyGrid size={{ xs: 12, md: 6 }}>
              ...
              <MyTypography>{state.dtoEvent.status}</MyTypography>
            </MyGrid>
          </MyGrid>
        </MyCardContent>
        <MyDivider />
