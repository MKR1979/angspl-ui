...
import ClientTrackPresenceList from './client-track-presence-list';
...
export default async function TrackPresenceListPage() {
  ...
  return <ClientTrackPresenceList arrTrackPresenceDTO={arrTrackPresenceDTO} total_records={total_records}></ClientTrackPresenceList>;
}
