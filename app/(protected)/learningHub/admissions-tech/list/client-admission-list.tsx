    ...
    },
    {
      ...
      renderCell: useCallback(
        (params: GridRenderCellParams) =>
          findPermission(userPermissions, 4) ? (
            <MyLink href={`/${gConstants.ADMIN_STUDENT_DASHBOARD}/admissions-tech/view/` + params.row.id}>{params.row.course_name}</MyLink>
          ) : (
        ...
        <MyCardContent sx={{ overflowX: 'auto' }}>
          <div style={{ minWidth: `${columns.length * 150}px` }}>
            <MyDataGrid
              ...
              showAddButton={findPermission(userPermissions, 1)}
              onDeleteClick={onDeleteAllClick}
              showDeleteButton={state.arrSelectedId.length > 0 && findPermission(userPermissions, 2)}
          ...
          {(findPermission(userPermissions, 2) || findPermission(userPermissions, 3) || findPermission(userPermissions, 204)) && (
            <MyMenu
            ...
            >
              {findPermission(userPermissions, 3) && (
              ...
              {findPermission(userPermissions, 204) && (
              ...
              {findPermission(userPermissions, 2) && (
