  ...
  return (
    <>
      ...
      <MyCard>
          ...
          <MyGrid container spacing={2}>
            ...
            <MyGrid size={{ xs: 12, md: 6 }}>
              <MyBox sx={{ mb: 0 }}>
                ...
                <MyTypography variant="subtitle2">{state.dtoQuiz.quiz_type}</MyTypography>
              </MyBox>
            </MyGrid>
            <MyGrid size={{ xs: 12, md: 6 }}>
              <MyBox sx={{ mb: 0 }}>
                ...
                <MyTypography variant="subtitle2">
                  {state.dtoQuiz.exam_duration} Min{state.dtoQuiz.exam_duration !== 1 ? 's.' : '.'}
                </MyTypography>
              </MyBox>
            </MyGrid>
            <MyGrid size={{ xs: 12, md: 6 }}>
        ...
        ></MyTimestamp>
        <MyCardActions>
          {findPermission(userPermissions, 118) && <MyButton onClick={onEditClick}>Edit</MyButton>}
