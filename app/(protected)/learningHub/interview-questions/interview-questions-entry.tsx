...
import useInterviewQuestionsEntry from './useInterviewQuestionsEntry';
...
type InterviewQuestionsEntryProps = {
  dtoInterviewQuestions: InterviewQuestionsDTO;
  arrCourseLookup: LookupDTO[];
};

const InterviewQuestionsEntry = (props: InterviewQuestionsEntryProps) => {
  const {
    state,
    onInputChange,
    onPlainInputChange,
    ...
    setClose2,
    saving
  } = useInterviewQuestionsEntry(props);
        ...
        <MyGrid container spacing={2}>
          <MyGrid size={{ xs: 12, sm: 6 }}>
            <MyAutocomplete
              ...
              onClose={setClose1}
              value={{
                id: state.dtoInterviewQuestions.course_id,
                text: state.dtoInterviewQuestions.course_name
              }}
          ...
          <MyGrid size={{ xs: 12, sm: 6 }}>
            <MyTextField
              label="Title"
              name="title"
              value={state.dtoInterviewQuestions.title}
          ...
          <MyGrid size={{ xs: 12, sm: 6 }}>
            <MyAutocomplete
              ...
              onOpen={setOpen2}
              onClose={setClose2}
              value={{ text: state.dtoInterviewQuestions.status }}
              getOptionLabel={(option: any) => option.text}
              firstitem={{ id: 0, text: '' }}
          ...
          <MyGrid size={{ xs: 12, sm: 12 }}>
            <MyTextField
              label="Description"
              name="description"
              value={state.dtoInterviewQuestions.description}
...
export default memo(InterviewQuestionsEntry, (prevProps, nextProps) => {
