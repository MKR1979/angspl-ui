...
import ClientAddInterviewQuestions from './client-add-interview-questions';
...
export default async function AddInterviewQuestionsPage() {
  ...
  return <ClientAddInterviewQuestions arrCourseLookup={arrCourseLookup}></ClientAddInterviewQuestions>;
}
