        ...
        <MyGrid container spacing={2}>
          ...
          <MyGrid size={{ xs: 12, sm: 6 }}>
            <MyTextField
              ...
              inputProps={{
                maxLength: Constants.CODE_PROJECT_TITLE_LENGTH,
                pattern: '^[A-Za-z]{1,2}$'
              }}
              onBlur={onTitleBlur}
          ...
          <MyGrid size={{ xs: 12, sm: 12 }}>
            <MyTextField
              ...
              maxRows={14} // Optional: limit max expansion
              fullWidth
            />
            <MyTypography className="error">{state.errorMessages.source_code}</MyTypography>
          </MyGrid>
        </MyGrid>
      </MyCardContent>
