...
import ClientAddVideoUploads from './client-add-video-uploads';
...
export default async function AddVideoUploadsPage() {
  ...
  return <ClientAddVideoUploads arrCourseLookup={arrCourseLookup}></ClientAddVideoUploads>;
}
