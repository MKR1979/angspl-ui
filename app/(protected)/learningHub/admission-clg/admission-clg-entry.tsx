...
import useAdmissionClgEntry from './useAdmissionClgEntry';
...
type AdmissionClgEntryProps = {
  dtoAdmissionClg: AdmissionClgDTO;
};

const AdmissionClgEntry = (props: AdmissionClgEntryProps) => {
  const {
    state,
    saving,
    isSameAddress,
    ...
    onRollNoChange,
    onEntryTypeBlur,
    onUndertakingChange, onAdmissionDateChange, onAdmissionDateBlur, onNormalizedInputChange,
  } = useAdmissionClgEntry(props);
      ...
      <MyLocalizationProvider>
        <MyGrid container spacing={2} style={{ border: '3px solid rgb(238, 242, 246)', padding: '0.1rem 1rem' }}>
          ...
          <MyGrid size={{ xs: 12 }} sx={{ mt: '-10px' }}>
            <MyTypography variant="h6" sx={{ fontWeight: 'bold', fontSize: '1.0rem', borderBottom: '2px solid #999999' }}>
              Personal Details
            </MyTypography>
          </MyGrid>
            ...
            <>
              ...
              <MyGrid size={{ xs: 12, sm: 3 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen22}
                  onClose={setClose22}
                  value={state.arrEduPassingYear.find((opt: any) => opt.text === String(state.dtoAdmissionClg.high_school_year)) || null}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 2.5 }}>
                <MyTextField
                  ...
                  onChange={onRollNoChange('high_school_roll_no')}
            ...
            <>
              ...
              <MyGrid size={{ xs: 12, sm: 3 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen23}
                  onClose={setClose23}
                  value={state.arrEduPassingYear.find((opt: any) => opt.text === String(state.dtoAdmissionClg.intermediate_year)) || null}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrEduPassingYear}
              ...
              <MyGrid size={{ xs: 12, sm: 2.5 }}>
                <MyTextField
                  ...
                  onChange={onRollNoChange('intermediate_roll_no')}
            ...
            <>
              ...
              <MyGrid size={{ xs: 12, sm: 4 }}>
                <MyAutocomplete
                  ...
                  onClose={setClose34}
                  value={
                    state.arrEduPassingYear.find((opt: any) => opt.text === String(state.dtoAdmissionClg.diploma_passing_year)) || null
                  }
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrEduPassingYear}
            ...
            <>
              ...
              <MyGrid size={{ xs: 12, sm: 4 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen25}
                  onClose={setClose25}
                  value={state.arrEduPassingYear.find((opt: any) => opt.text === String(state.dtoAdmissionClg.ug_passing_year)) || null}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrEduPassingYear}
            ...
            <>
              ...
              <MyGrid size={{ xs: 12, sm: 4 }}>
                <MyAutocomplete
                  ...
                  value={state.arrEduPassingYear.find((opt: any) => opt.text === String(state.dtoAdmissionClg.pg_passing_year)) || null}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrEduPassingYear}
          ...
          {isEditMode && (
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                ...
                onOpen={setOpen18}
                onClose={setClose18}
                value={{ text: state.dtoAdmissionClg.status }}
                getOptionLabel={(option: any) => option.text}
                firstitem={{ id: 0, text: '' }}
                options={state.arrAdmissionStatusLookup}
                onChange={onPassingYearChange('status')}
                onBlur={onStatusBlur}
                filterOptions={(options, state) => {
                  const searchTerm = state.inputValue.toLowerCase();
                  return options.filter((option: any) => option.text && option.text.toLowerCase().includes(searchTerm));
          ...
          <MyGrid size={{ xs: 12 }}>
            ...
            <ul style={{ paddingLeft: '1.5rem', listStyleType: 'disc' }}>
              <li>
                I fully understand that submission of this application form does not in any way guarantee admission to the college. I also
                agree that the decision of the college authorities regarding admission will be final and binding on me.
              </li>
              <li>
                I am aware that admission will be offered strictly subject to availability of seats, fulfillment of eligibility criteria,
                and submission of all required documents.
              </li>
              <li>
                I hereby certify that the Date of Birth, academic records, and personal details provided in this form are true and correct.
                I shall not request any alteration in these details once submitted.
              </li>
              <li>
                I undertake that the information / documents submitted are authentic and not misleading. I understand that submission of
                false or misleading information, or concealment of relevant details, may result in cancellation of admission at any stage of
                my studies at this college.
              </li>
            </ul>
            ...
            <ul style={{ paddingLeft: '1.5rem', listStyleType: 'disc' }}>
              <li>
                Admission / Registration for a particular academic year is <strong>non-transferable</strong> to any other year or to another
                student.
              </li>
              <li>
                Submission of the application form or payment of registration fee does not guarantee admission. Admission will be based on
                merit, eligibility criteria, and availability of seats.
              </li>
              <li>
              ...
              <li>
                Certificates for achievements in sports, cultural activities, or other co-curricular fields (if any) should be attached
                along with the form.
              </li>
...
export default memo(AdmissionClgEntry, (prevProps, nextProps) => {
