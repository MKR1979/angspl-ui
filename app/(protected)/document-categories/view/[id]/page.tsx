...
import ClientViewDocumentCategory from './client-view-document-category';
...
export default async function ViewDocumentCategoryPage({ params }: Props) {
  ...
  return <ClientViewDocumentCategory dtoDocumentCategory={dtoDocumentCategory}></ClientViewDocumentCategory>;
}
