...
import ClientEditScheduleFee from './client-edit-schedule-fee';
...
export default async function EditScheduleFeePage({ params }: Props) {
  ...
  return <ClientEditScheduleFee dtoScheduleFee={dtoScheduleFee} />;
}
