...
const ClientDocumentList = ({ arrDocumentDTO, total_records }: Props) => {
  const {
    state,
    apiRef,
    paginationModel,
    ...
    onRowDoubleClick,
    onDeleteSingleClose
  } = useDocumentList({ arrDocumentDTO, total_records });
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: useCallback(
        (params: GridRenderCellParams) => <MyLink href={'/documents/view/' + params.row.id}>{params.row.document_name}</MyLink>,
        []
      )
    },
    {
...
export default memo(ClientDocumentList, (prevProps, nextProps) => {
