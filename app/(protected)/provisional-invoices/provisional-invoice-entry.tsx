...
import useProvisionalInvoiceEntry from './useProvisionalInvoiceEntry';
...
import { arrDiscountType, arrLeadTime, arrProvisionalInvoiceStatus, getLocalTime, numberFormat } from '@/app/common/Configuration';
...
type ProvisionalInvoiceEntryProps = {
...
const ProvisionalInvoiceEntry = (props: ProvisionalInvoiceEntryProps) => {
  const {
    apiRef,
    paginationModel,
    setPaginationModel,
    ...
    handleTabChange,
    onCopyClick
  } = useProvisionalInvoiceEntry(props);
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      valueFormatter: useCallback(
        (value: any) => (value ? state.dtoProvisionalInvoice.currency_symbol + numberFormat(Number(value), 2) : ''),
        [state.dtoProvisionalInvoice.currency_symbol]
      )
    },
    {
  ...
  return (
    <MyLocalizationProvider>
          ...
          <MyTabPanel value={state.tabIndex} index={0}>
            <MyGrid container spacing={2}>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField label="Provisional Invoice #" value={state.dtoProvisionalInvoice.provisional_invoice_no} disabled />
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyDatePicker
                  label="Provisional Invoice Date"
                  onChange={onProvisionalInvoiceDateChange}
                  value={
                    dayjs(getLocalTime(state.dtoProvisionalInvoice.provisional_invoice_date)).format('MM/DD/YYYY') === '12/31/1899'
                      ? null
                      : dayjs(getLocalTime(state.dtoProvisionalInvoice.provisional_invoice_date)).toDate()
                  }
                  onBlur={onProvisionalInvoiceDateBlur}
                  error={state.errorMessages.provisional_invoice_date ? true : false}
                ></MyDatePicker>
                <MyTypography className="error"> {state.errorMessages.provisional_invoice_date}</MyTypography>
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  disabled={state.dtoProvisionalInvoice.id > 0}
                  open={state.open17}
                  onOpen={setOpen17}
                  onClose={setClose17}
                  value={{ id: state.dtoProvisionalInvoice.order_id, text: state.dtoProvisionalInvoice.order_no }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrOrderLookup}
                  onChange={onOrderNoChange}
                  onBlur={onOrderNoBlur}
                  renderInput={(params) => (
                    <MyTextField
                      {...params}
                      label="Order #"
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  disabled={state.dtoProvisionalInvoice.order_id > 0}
                  open={state.open1}
                  onOpen={setOpen1}
                  onClose={setClose1}
                  value={{ id: state.dtoProvisionalInvoice.customer_id, text: state.dtoProvisionalInvoice.customer_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen3}
                  onClose={setClose3}
                  value={{ id: state.dtoProvisionalInvoice.contact_id, text: state.dtoProvisionalInvoice.contact_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.customer_ref_no}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen4}
                  onClose={setClose4}
                  value={{ id: state.dtoProvisionalInvoice.incoterm_id, text: state.dtoProvisionalInvoice.incoterm_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen5}
                  onClose={setClose5}
                  value={{ id: state.dtoProvisionalInvoice.term_id, text: state.dtoProvisionalInvoice.term_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyDatePicker
                  ...
                  onChange={onEstimatedShippingDateChange}
                  value={
                    dayjs(getLocalTime(state.dtoProvisionalInvoice.estimated_shipping_date)).format('MM/DD/YYYY') === '12/31/1899'
                      ? null
                      : dayjs(getLocalTime(state.dtoProvisionalInvoice.estimated_shipping_date)).toDate()
                  }
                ></MyDatePicker>
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyDatePicker
                  ...
                  value={
                    dayjs(getLocalTime(state.dtoProvisionalInvoice.expires_on)).format('MM/DD/YYYY') === '12/31/1899'
                      ? null
                      : dayjs(getLocalTime(state.dtoProvisionalInvoice.expires_on)).toDate()
                  }
                ></MyDatePicker>
              </MyGrid>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onClose={setClose11}
                  value={{
                    id: state.dtoProvisionalInvoice.currency_id,
                    text: state.dtoProvisionalInvoice.currency_name
                  }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onClose={setClose16}
                  value={{
                    text: state.dtoProvisionalInvoice.status
                  }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ text: '' }}
                  options={arrProvisionalInvoiceStatus}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  label="Notes"
                  name="notes"
                  value={state.dtoProvisionalInvoice.notes}
                  onChange={onInputChange}
                />
              </MyGrid>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  label="Total Amount"
                  value={numberFormat(state.dtoProvisionalInvoice.total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
                      inputProps: { prefix: state.dtoProvisionalInvoice.currency_symbol }
                    }
                  }}
                />
              </MyGrid>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoProvisionalInvoice.discount_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoProvisionalInvoice.sub_total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  label="Tax Amount"
                  value={numberFormat(state.dtoProvisionalInvoice.tax_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.shipping_charges}
                  onChange={onInputChange}
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyBox sx={{ display: 'flex' }}>
                  <MyAutocomplete
                    ...
                    onOpen={setOpen10}
                    onClose={setClose10}
                    value={{ id: state.dtoProvisionalInvoice.shipping_tax_id, text: state.dtoProvisionalInvoice.shipping_tax_description }}
                    getOptionLabel={(option: any) => option.text}
                    firstitem={{ id: 0, text: '' }}
                  ...
                  <MyTextField
                    ...
                    value={numberFormat(state.dtoProvisionalInvoice.shipping_tax_amount, 2)}
                    disabled
                    slotProps={{
                      input: {
                        inputComponent: MyNumericFormat as any,
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={numberFormat(state.dtoProvisionalInvoice.grand_total_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid container spacing={2}>
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.billing_address}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.billing_city_name}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen12}
                  onClose={setClose12}
                  value={{ id: state.dtoProvisionalInvoice.billing_state_id, text: state.dtoProvisionalInvoice.billing_state_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen13}
                  onClose={setClose13}
                  value={{ id: state.dtoProvisionalInvoice.billing_country_id, text: state.dtoProvisionalInvoice.billing_country_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.billing_zip_code}
                  onChange={onInputChange}
            ...
            <MyGrid container spacing={2}>
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.shipping_address}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.shipping_city_name}
                  onChange={onInputChange}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen14}
                  onClose={setClose14}
                  value={{ id: state.dtoProvisionalInvoice.shipping_state_id, text: state.dtoProvisionalInvoice.shipping_state_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen15}
                  onClose={setClose15}
                  value={{ id: state.dtoProvisionalInvoice.shipping_country_id, text: state.dtoProvisionalInvoice.shipping_country_name }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrCountryLookup}
              ...
              <MyGrid size={{ xs: 12, sm: 6 }}>
                <MyTextField
                  ...
                  value={state.dtoProvisionalInvoice.shipping_zip_code}
                  onChange={onInputChange}
      ...
      <MyDialog
        ...
        fullWidth
      >
        <MyDialogTitle> {state.dtoProvisionalInvoiceItem.item_no > 0 ? 'Edit' : 'Add'} ProvisionalInvoice Item</MyDialogTitle>
        <MyIconButton
          aria-label="close"
          ...
          <MyGrid container spacing={2}>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                ...
                onOpen={setOpen6}
                onClose={setClose6}
                value={{ id: state.dtoProvisionalInvoiceItem.product_id, text: state.dtoProvisionalInvoiceItem.product_name }}
                getOptionLabel={(option: any) => option.text}
                firstitem={{ id: 0, text: '' }}
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField label="Product Code" name="productcode" value={state.dtoProvisionalInvoiceItem.part_number} disabled={true} />
            </MyGrid>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField label="Unit" value={state.dtoProvisionalInvoiceItem.unit_name} disabled={true} />
            </MyGrid>
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Quantity"
                name="qty"
                value={state.dtoProvisionalInvoiceItem.qty}
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Price"
                name="price"
                value={state.dtoProvisionalInvoiceItem.price}
                onChange={onInputChange1}
                onBlur={onPriceBlur}
                slotProps={{
                  input: {
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyBox sx={{ display: 'flex' }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen8}
                  onClose={setClose8}
                  value={{ text: state.dtoProvisionalInvoiceItem.discount_type }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ text: '' }}
                ...
                <MyTextField
                  label="Discount"
                  name="discount"
                  value={state.dtoProvisionalInvoiceItem.discount}
                  onChange={onInputChange1}
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
                      inputProps: {
                        prefix:
                          state.dtoProvisionalInvoiceItem.discount_type === 'Fixed' ? state.dtoProvisionalInvoice.currency_symbol : '',
                        suffix: state.dtoProvisionalInvoiceItem.discount_type === 'Fixed' ? '' : '%'
                      }
                    }
                  }}
                  sx={{ mr: 1 }}
                ...
                <MyTextField
                  label="Discount Amount"
                  value={numberFormat(state.dtoProvisionalInvoiceItem.discount_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyBox sx={{ display: 'flex' }}>
                <MyAutocomplete
                  ...
                  onOpen={setOpen9}
                  onClose={setClose9}
                  value={{ id: state.dtoProvisionalInvoiceItem.tax_id, text: state.dtoProvisionalInvoiceItem.tax_description }}
                  getOptionLabel={(option: any) => option.text}
                  firstitem={{ id: 0, text: '' }}
                  options={state.arrTaxLookup}
                ...
                <MyTextField
                  label="Tax Amount"
                  value={numberFormat(state.dtoProvisionalInvoiceItem.tax_amount, 2)}
                  disabled
                  slotProps={{
                    input: {
                      inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyTextField
                label="Amount"
                name="amount"
                value={numberFormat(state.dtoProvisionalInvoiceItem.amount, 2)}
                disabled={true}
                slotProps={{
                  input: {
                    inputComponent: MyNumericFormat as any,
            ...
            <MyGrid size={{ xs: 12, sm: 6 }}>
              <MyAutocomplete
                ...
                disableClearable
                options={arrLeadTime}
                value={state.dtoProvisionalInvoiceItem.lead_time}
      ...
      {state.visibleDialog && (
        <MyConfirmDialog
          ...
          title="Confirm Provisional Invoice Item Removal"
        ...
        >
          <MyTypography variant="body1">
            {' '}
            Are you sure you want to delete this Provisional Invoice item? This cannot be undone.
          </MyTypography>
        </MyConfirmDialog>
      )}
      {state.visibleDialog1.visibility && (
        ...
        >
          <MyTypography variant="body1">Are you sure you want to delete this Provisional Invoice item? This cannot be undone.</MyTypography>
        </MyConfirmDialog>
      )}
    </MyLocalizationProvider>
  );
...
export default memo(ProvisionalInvoiceEntry, (prevProps, nextProps) => {
