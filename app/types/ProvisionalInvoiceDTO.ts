...
export default interface ProvisionalInvoiceDTO extends BaseDTO {
...
export const PROVISIONAL_INVOICE: ProvisionalInvoiceDTO = Object.freeze({
  id: 0,
  provisional_invoice_no: '',
  provisional_invoice_date: new Date(1899, 11, 31),
  order_id: 0,
  order_no: '',
  customer_id: 0,
  customer_name: '',
  ...
  term_id: 0,
  term_description: '',
  estimated_shipping_date: new Date(1899, 11, 31),
  expires_on: new Date(1899, 11, 31),
  billing_address: '',
  billing_city_name: '',
  billing_state_id: 0,
  billing_state_code: '',
