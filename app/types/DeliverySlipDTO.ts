...
export default interface DeliverySlipDTO extends BaseDTO {
...
export const DELIVERY_SLIP: DeliverySlipDTO = Object.freeze({
  id: 0,
  delivery_slip_no: '',
  delivery_slip_date: new Date(1899, 11, 31),
  customer_id: 0,
  customer_name: '',
  contact_id: 0,
  contact_name: '',
